# V19-018 Replay Timeline Control

## Goal
Implement Replay Timeline Control for roadmap_1_9 so the new graph-first workbench becomes the primary Versefina product center.

## Acceptance
- Replay Timeline Control is visible and usable in the roadmap_1_9 workbench flow.
...
- docs/requirements/v19-018_delivery.md
