# V19-017 Trade Card Flyouts and Symbol Heat

## Goal
Implement Trade Card Flyouts and Symbol Heat for roadmap_1_9 so the new graph-first workbench becomes the primary Versefina product center.

## Acceptance
- Trade Card Flyouts and Symbol Heat is visible and usable in the roadmap_1_9 workbench flow.
...
- docs/requirements/v19-017_delivery.md
