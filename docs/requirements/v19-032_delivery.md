# V19-032 Failure Taxonomy and Regime Pattern Cards

## Goal
Implement Failure Taxonomy and Regime Pattern Cards for roadmap_1_9 so the new graph-first workbench becomes the primary Versefina product center.

## Acceptance
- Failure Taxonomy and Regime Pattern Cards is visible and usable in the roadmap_1_9 workbench flow.
...
- docs/requirements/v19-032_delivery.md
