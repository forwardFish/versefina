# V19-028 Workbench Ask Orchestration

## Goal
Implement Workbench Ask Orchestration for roadmap_1_9 so the new graph-first workbench becomes the primary Versefina product center.

## Acceptance
- Workbench Ask Orchestration is visible and usable in the roadmap_1_9 workbench flow.
...
- docs/requirements/v19-028_delivery.md
